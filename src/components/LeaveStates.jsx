...
const LeaveStat = ({ leaveName='Study', leaveTotal='33', leaveTaken='10' }) => {
  ...
  const [randcolors] = useState( ['bg-white text-blue-400',  'bg-gray-400 text-gray-100', 'bg-green-400 text-green-100', 'bg-yellow-400 text-yellow-100' , 'bg-blue-400 text-blue-100' ])
